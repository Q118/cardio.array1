    ...
    const inventors = [
      ...
      //filter will loop through the array and give us what put in ()
                      //loop through inventors array for each of the inventor - do soemthing
      const fifteen = inventors.filter(inventor => {
              if(inventor.year < 1600 && inventor.year >= 1500) {
                      return true; //returning true will keep it 
              }
      });
      ...
      //reduce allows you to build something on each one
      /* 
      before es6... var totalYears = 0;
